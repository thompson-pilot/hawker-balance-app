...
def weightBalance(request):
	...
	minus_moments = float(minus_wing_parcial_mom) + float(PAX1_mom) + float(PAX2_mom) + float(PAX3_mom) + float(PAX4_mom) + float(PAX5_mom) + float(PAX6_mom) + float(PAX7_mom) + float(bagg1_mom)

	plus_moments = float(plus_wing_parcial_mom) + float(ventral_fuel_mom) + float(PAX8_mom) + float(PAX9_mom) + float(bagg2_mom) + float(bow_mom)
